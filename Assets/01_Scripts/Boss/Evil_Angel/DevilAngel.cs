...
public class DevilAngel : Boss
{
    ...
    {
        tornados[tornadoIndex].transform.position = new(playerPos.x + Random.Range(-2f, 2f), -61f, 0);
    ...
    void GenesisFire()
    {
        ...
        StartCoroutine(DelayIdle(delay + 1f));
    }
